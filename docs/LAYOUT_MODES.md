...
Tiling in TermOS has three layout modes, and there are two navigation features
...
Keys handled by TermOS itself (the leader key and its chords, overlays, workspace
